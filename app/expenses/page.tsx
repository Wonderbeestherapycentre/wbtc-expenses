...
import { fetchExpenses, fetchCategories } from "@/lib/data";
...
export default async function ExpensesPage({ searchParams }: { searchParams: any }) {
    ...
    if (period === "day") {
        ...
        startDate = startOfWeek(now, { weekStartsOn: 1 }); // Monday start? User didn't specify. Default is Sunday usually. Let's use Monday (ISO).
