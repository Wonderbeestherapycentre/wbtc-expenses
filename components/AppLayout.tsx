...
export default function AppLayout({ children, categories = [], familyChildren = [], familyStaffs = [] }: { children: React.ReactNode; categories?: Category[]; familyChildren?: any[]; familyStaffs?: any[] }) {
    ...
    return (
        <div className="h-screen overflow-hidden flex flex-col md:flex-row">
            <ExpenseModal isOpen={isAddExpenseOpen} onClose={() => setIsAddExpenseOpen(false)} categories={categories} familyChildren={familyChildren} familyStaffs={familyStaffs} />
