...
export default function CategoryIncomeChart({ data }: CategoryIncomeChartProps) {
    ...
    return (
        <div className="glass-card p-2 md:p-6 rounded-2xl h-[400px] animate-fade-in animate-delay-300">
            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-6">Income Source</h3>
