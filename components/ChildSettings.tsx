...
export default function ChildSettings({ children }: { children: Child[] }) {
                    ...
                    <table className="w-full min-w-[600px]">
                        <thead className="bg-gray-50/50 dark:bg-neutral-800/50 border-b border-gray-100 dark:border-neutral-800">
                            <tr>
                                ...
                                <th className="text-left py-3 px-3 md:py-4 md:px-6 text-xs font-semibold text-gray-500 uppercase">Status</th>
                        ...
                        <tbody className="divide-y divide-gray-100 dark:divide-neutral-800">
                            {children.length === 0 ? (
                                <tr>
                                    <td colSpan={3} className="py-8 text-center text-gray-500">No children added yet.</td>
                                </tr>
                            ) : (
                                children.map((child) => (
